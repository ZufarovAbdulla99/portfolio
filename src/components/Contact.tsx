...
import { ISocialLinkType } from "../types/SocialLinkType";

const socialLinks: ISocialLinkType[] = [
  {
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M22 2L2 10.93L9.18 13.11L18.5 5.5L11 14L11 19L14 16L18.09 19.09C18.73 19.61 19.61 19.61 20.25 19.09L22 2Z"
          fill="currentColor"
        />
      </svg>
    ),
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map((socialLink: ISocialLinkType, key: number) => (
              <a
                key={key}
        ...
        <form
          action="https://getform.io/f/anlqxepa"
          method="POST"
